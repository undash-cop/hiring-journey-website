      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 pt-16 pb-12 sm:pt-24 sm:pb-16">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm text-primary-100"
          >
            <a
              href={`mailto:${MARKETING_CONTACT.helloEmail}`}
              className="flex items-center gap-2 hover:text-white transition-colors"
            >
              <Mail className="h-5 w-5" aria-hidden />
              <span>{MARKETING_CONTACT.helloEmail}</span>
            </a>
            <a
              href={`tel:${MARKETING_CONTACT.phoneTel}`}
              className="flex items-center gap-2 hover:text-white transition-colors"
            >
              <Phone className="h-5 w-5" aria-hidden />
              <span>{MARKETING_CONTACT.phoneDisplay}</span>
            </a>
          </motion.div>
        </motion.div>
      </div>
