    ...
    return (
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <PageEmptyState
          ...
          description="Subscription plans will appear here once billing is integrated in Phase 5."
        />
      </div>
    );
  }
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button className="w-full sm:w-auto" disabled title="Plan creation ships with billing in Phase 5">
          Create New Plan
        </Button>
      </div>
