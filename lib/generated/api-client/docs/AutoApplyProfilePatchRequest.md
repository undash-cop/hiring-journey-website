...
**min_salary** | **number** |  | [optional] [default to undefined]
...
**skill_match_threshold** | **number** |  | [optional] [default to undefined]
...
**daily_apply_limit** | **number** |  | [optional] [default to undefined]
**apply_schedule** | **string** |  | [optional] [default to undefined]

## Example

```typescript
import { AutoApplyProfilePatchRequest } from './api';

const instance: AutoApplyProfilePatchRequest = {
    name,
    is_active,
    min_salary,
    locations,
